<?php
	 ...
	 $sql="SELECT * FROM appointment WHERE p_id = '$p_id'";
...
<html>
<head>
<title>Appointment:Cancel Booking</title>
</head>
<body>
<style> 
ul{
...
<ul id ="v1" >
  ...
  <li><a class="active" href="CancelBook.php">Cancel Bookings</a></li>
  <li><a href="AllDoctors.php">All Doctors</a></li>
  <li><a href="plogout.php">Logout</a></li>
</ul>

<h1 class="ex1">To cancel Select booking from table and press cancel button</h1>
...
<br>
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	   ...
	   UserId:<input type="text" name="p_id" id="p_id">
        UserName:<input type="text" name="p_name" id="p_name">
